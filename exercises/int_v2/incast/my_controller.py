...
def main(p4info_file, bmv2_json_file):
    ...
    try:
        ...
        write_l3_rule(p4info_helper, s1, "10.0.1.1", 32, "08:00:00:00:01:11", "08:00:00:00:01:00", 1) # h1
        write_l3_rule(p4info_helper, s1, "10.0.1.2", 32, "08:00:00:00:01:22", "08:00:00:00:01:00", 2) # h2
        write_l3_rule(p4info_helper, s1, "10.0.1.3", 32, "08:00:00:00:01:33", "08:00:00:00:01:00", 3) # h3
        # Send traffic for h_dst and h_report to s2 (port 4)
        write_l3_rule(p4info_helper, s1, h_dst_ip, 32, "00:00:00:02:01:00", "00:00:00:01:02:00", 4) # to s2
        write_l3_rule(p4info_helper, s1, h_report_ip, 32, "00:00:00:02:01:00", "00:00:00:01:02:00", 4) # to s2

        # INT Source Rules for s1
        write_source_port_activation(p4info_helper, s1, ingress_port=1)
        write_source_port_activation(p4info_helper, s1, ingress_port=2)
        write_source_port_activation(p4info_helper, s1, ingress_port=3)
